            ...
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28 backdrop-blur-lg bg-white/10 rounded-3xl shadow-2xl">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7 p-8">
                    ...
                    <div id="hero-title-container-text" class="flex">
                        <h1 id="hero-title" class="flex-1 max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl text-white text-shadow-lg">Elevate Your Cricket Experience</h1>
                    </div>

                    <div id="hero-subtitle-container" class="flex">
                        <p id="hero-subtitle" class="flex-1 max-w-2xl mb-6 font-light text-pink-100 lg:mb-8 md:text-lg lg:text-xl">Real-time Scores, Stats and Analysis</p>
                    </div>

                    <div id="hero-buttons-container" class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <div id="hero-button-1-container" class="flex">
                            <a id="hero-button-1" href="https://github.com/themesberg/landwind" class="flex-1 items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-purple-900 bg-white/30 backdrop-blur-md rounded-lg sm:w-auto hover:bg-white/50 focus:ring-4 focus:ring-purple-300 transition duration-300">Get the App</a>
                        </div>

                        <div id="hero-button-2-container" class="flex">
                            <a id="hero-button-2" href="https://www.figma.com/community/file/1125744163617429490" class="flex-1 items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-purple-900 bg-white/30 backdrop-blur-md rounded-lg sm:w-auto focus:outline-none hover:bg-white/50 focus:ring-4 focus:ring-purple-300 transition duration-300">Learn More</a>
                        </div>
                    </div>
